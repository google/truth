 ...
 * {@link #failComparing} in terms of {@link #fail(String, Throwable)}.
 * For most implementations this should be sufficient and easier to use than directly extending
 * {@code FailureStrategy}.
 */
