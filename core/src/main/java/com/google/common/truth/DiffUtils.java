...
final class DiffUtils {
  ...
  private List<String> diff(
    ...
    DiffCalc d1 = new DiffCalc(original, revised, lcs, offsetHead, reducedUnifiedDiff, stringList);
    d1.calcUnifiedDiff(originalLines.size(), revisedLines.size());

    d1.calcReducedUnifiedDiff(contextSize);
