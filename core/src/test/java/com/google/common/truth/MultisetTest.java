...
public class MultisetTest {
  ...
  @Test public void multisetIsNotEmpty() {
    ImmutableMultiset<Integer> multiset = ImmutableMultiset.of(1, 5);
    assertThat(multiset).isNotEmpty();
  }

  @Test public void multisetIsNotEmptyWithFailure() {
  ...
  @Test public void containsFailure() {
    ...
    try {
      ...
      assertThat(e).hasMessage(
          "<[kurt, kluever]> should have contained <greg>");
      return;
    }
    fail("Should have thrown.");
  }

  @Test public void containsNullFailure() {
    ImmutableMultiset<String> multiset = ImmutableMultiset.of("kurt", "kluever");
    try {
      assertThat(multiset).contains(null);
    } catch (AssertionError e) {
      assertThat(e).hasMessage(
          "<[kurt, kluever]> should have contained <null>");
      return;
    }
    fail("Should have thrown.");
  }
  ...
  @Test public void doesNotContainFailure() {
    ...
    try {
      ...
      assertThat(e).hasMessage(
          "<[kurt, kluever]> should not have contained <kurt>");
    }
  }

  @Test public void doesNotContainNull() {
    Multiset<String> multiset = HashMultiset.create();
    multiset.add(null);
    try {
      assertThat(multiset).doesNotContain(null);
      ...
      assertThat(e).hasMessage(
          "<[null]> should not have contained <null>");
    }
  }
}
